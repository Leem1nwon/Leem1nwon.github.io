...
**장점:** 프로그램이 메모리 내에서의 위치를 실시간으로 변경할 수 있고, 실제 물리 메모리 크기에 구애받지 않는 가상의 메모리 공간을 사용할 수 있음. 각 프로그램이 논리적으로 분리된 주소 영역을 사용하여 메모리 충돌을 피할 수 있음.
...
![ARM Cortex M3](../../images/2025-03-16-Embedded/ARM%20Cortex%20M3.png)
